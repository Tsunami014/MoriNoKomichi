...
R"(<table width="100%" cellspacing="0"><tr><td align="center">)" // Table hack to get centring
    ...
    "<h3>Tasks</h3><ul>"
        "<li>Create a task by pressing the plus button in the bottom right corner, adding a name and clicking one of the add to section buttons</li>"
        "<li>View a task by clicking on it (clicking the back arrow or the overlay will bring you back)</li>"
        "<li>Rename a task by clicking on its title in the expanded view</li>"
        "<li>Move a task by clicking on another section in the expanded view</li>"
        "<li>Change task priority by changing the number in the box labelled 'Priority:' in the expanded view</li>"
        "<li>Delete a task by clicking on the delete button in the expanded view</li>"
    "</ul><h3>Subtasks (or todos)</h3><ul>"
        "<li>Create a subtask by typing in the box labelled 'New subtask' in the expanded task view and pressing 'enter'</li>"
